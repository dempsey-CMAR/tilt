#' Plot tilt data coloured by flag value
#'
#' @param dat Data frame of flagged tilt data in long or wide format. Must
...
tilt_ggplot_flags <- function(
  ...
  p <- dat %>%
    ...
    facet_wrap(~variable_label, ncol = n_col, scales = "free_y")
